...
export const SPECS: Record<ExportType, ExportSpec> = {
  billing_export: {
    ...
    columns: [
      ...
      { name: "line_number",   kind: "int",     required: true, aliases: ["line", "line_no", "svc_line"] },
      ...
      { name: "facility_id",   kind: "text",    required: false, aliases: ["facility", "service_facility"] },
      ...
      { name: "modifiers",     kind: "text",    required: false, aliases: ["modifier", "mods"] },
  ...
  era: {
    ...
    columns: [
      { name: "claim_id",        kind: "text",      required: true },
      { name: "line_number",     kind: "int",       required: true, aliases: ["line", "svc_line"] },
  ...
  ris: {
    ...
    columns: [
      ...
      { name: "facility_id",       kind: "text",      required: false, aliases: ["facility"] },
      { name: "rendering_npi",     kind: "text",      required: false, aliases: ["npi"] },
      { name: "finalized_at",      kind: "timestamp", required: false, aliases: ["finalized", "final_date"] },
    ],
  },
  bank: {
    type: "bank",
    ...
    columns: [
      { name: "deposit_date", kind: "date",    required: true,  aliases: ["date", "posted_date"] },
