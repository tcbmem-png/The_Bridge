    ...
    <section id="act-problem" className="relative border-b border-ink/15">
      <div className="mx-auto max-w-6xl px-4 py-20 md:py-28">
        <div ref={headRef} className="reveal">
          <SectionTag tone="red">Problem · Follow the fall</SectionTag>
        ...
        <div className="mt-14 grid grid-cols-1 gap-10 md:grid-cols-12">
          <div className="md:col-span-7">
            <p className="text-lg leading-relaxed text-ink/85">
              A physician group reads for a hospital system under contract. The hospital mandates emergency, trauma, and overnight coverage. Payer mix means a large share of that volume never collects — and the group eats the labor on every read regardless. <strong>If the hospital isn't paid, neither is the group.</strong>
            </p>
            <p className="mt-6 text-lg leading-relaxed text-ink/85">
              And the rate keeps falling. Medicare pays less per unit of work in 2026 than it did in 2025 — and the mandated, uncollected coverage volume doesn't shrink to match.<sup className="text-[0.65em] text-ink/60">[1]</sup><sup className="text-[0.65em] text-ink/60">[2]</sup>
            </p>
          </div>
          ...
          <aside className="md:col-span-5">
            <div className="rounded-lg border border-ink/20 bg-paper p-5">
              ...
              <div className="mt-1 text-sm text-ink/70">
                exams read per year across {CONFIG.partnerCount.toLocaleString()} partners.
              </div>
        ...
        <div className="mt-12 rounded-lg border-l-2 border-[var(--teal)] bg-paper p-5 md:p-6">
          <p className="text-base leading-relaxed text-ink/85">
            One federal brake on over-ordering — Medicare's Appropriate Use Criteria — has been paused since January 2024, with no restart date.<sup className="text-[0.65em] text-ink/60">[3]</sup> The fix can't wait for Washington. It has to be operational.
          </p>
